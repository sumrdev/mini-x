...
We also have automated testing which provides a sense of feedback loop in the continuous delivery to ensure that the quality and functionality of the code remains as we expect.
